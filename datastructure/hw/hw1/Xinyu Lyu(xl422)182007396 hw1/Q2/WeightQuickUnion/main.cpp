//Xinyu Lyu 182007396
//Instructions: For this program, first you need to create a project and add "WeightQuickUnion.h" to head file folder,"WeightQuickUnion.cpp","main.cpp" these two files into the resource folder 
//in VS 2015 IDE, to change the file name in the member funnction "void UF::load(vector<int>&a, vector<int>&b)" in the "WeightQuickUnion.cpp", 
